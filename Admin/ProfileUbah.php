            ...
            <div class="row">
               <div class="col-xl-4">
                  <div class="card">
                     ...
                     <div class="card-body">
                        <h5 class="card-title"><?= $adminProfile['Nama_Admin'] ?></h5>
                     </div>
                  </div>
               </div>
               <div class="col-xl-8">
                     ...
                     <div class="card-body pt-3">
                           ...
                           <div class="tab-pane fade show active profile-overview" id="ubahProfil">
                              ...
                              <form action="" method="post" enctype="multipart/form-data">
                                 <input type="hidden" name="gambarLama" value="<?= $adminProfile["Foto_Profil"]?>" >
                                 <div class="row mb-3">
                                    <label for="uname_Admin" class="col-md-4 col-lg-3 col-form-label">ID/Username Admin</label>
                                    <div class="col-md-8 col-lg-9"> <input name="uname_Admin" type="text" class="form-control" id="uname_Admin" value="<?= $adminProfile['uname_Admin'] ?>" readonly></div>
                                 </div>
                                 <div class="row mb-3">
                                    <label for="Nama_Admin" class="col-md-4 col-lg-3 col-form-label">Nama Admin</label>
                                    <div class="col-md-8 col-lg-9"> <input name="Nama_Admin" type="text" class="form-control" id="Nama_Admin" value="<?= $adminProfile['Nama_Admin'] ?>"></div>
                                 </div>
                                 <div class="row mb-3">
                                    <label for="Telepon" class="col-md-4 col-lg-3 col-form-label">Telepon Admin</label>
                                    <div class="col-md-8 col-lg-9"> <input name="Telepon" type="text" class="form-control" id="Telepon" value="<?= $adminProfile['Telepon']?>"></div> 
                                 </div>
                                 <div class="row mb-3">
                                    <label for="Email" class="col-md-4 col-lg-3 col-form-label">Email Admin</label>
                                 ...
                                 <div class="text-center"> 
                                    <button type="submit" name="ubahProfil" class="btn btn-primary">Ubah Detail Admin</button>
                                 </div>
                              </form>
                           </div>
                        </div>
